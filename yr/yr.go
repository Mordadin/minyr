...
func ConvTemperature() {
	...
	for scanner.Scan() {
		...
		if err != nil {
    		...
    		fahrenheit := conv.CelsiusToFarenheit(celsius)
...
footer := []string{"Data er basert paa gyldig data (per 18.03.2023)(CC BY 4.0) fra Meteorologisk institutt (MET); endringen er gjort av Ruben Teikari"}
...
func ProcessLine(line string) string {
	...
	if line[0:7] == "Data er" {
		return "Data er basert paa gyldig data (per 18.03.2023) (CC BY 4.0) fra Meteorologisk institutt (MET);endringen er gjort av Ruben Teikari"
	} else {
